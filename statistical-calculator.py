...
def calculate_central_tendency():
    ...
    numbers = [float(num) for num in numbers.split() if num.strip()]  # Split input using commas and convert to a list of floats
    ...
    if numbers:
        ...
        result_label.config(text="Please enter a valid list of numbers")

# Adding widgets to the Main window
title_label = Label(text='Title: Measure of Central Tendency and Dispersion', font=('Arial', 16))
author_label = Label(text='''Author Details: jagjeet and Arif''', font=('Arial', 12,))
title_label.pack()
author_label.pack()
...
var = IntVar()
r1_ct = Radiobutton(text="Arithmetic Mean", variable=var, value=1, font=("Arial", 10))
r1_ct.place(x=10, y=200)
r2_ct = Radiobutton(text="Harmonic Mean", variable=var, value=2, font=("Arial", 10))
r2_ct.place(x=10, y=220)
r3_ct = Radiobutton(text="Geometric Mean", variable=var, value=3, font=("Arial", 10))
r3_ct.place(x=10, y=240)
r4_ct = Radiobutton(text="Mode", variable=var, value=4, font=("Arial", 10))
r4_ct.place(x=10, y=260)
r5_ct = Radiobutton(text="Median", variable=var, value=5, font=("Arial", 10))
r5_ct.place(x=10, y=280)

dispLabel = Label(text='Measure of Dispersion', font=('Arial', 12))
dispLabel.place(x=10, y=310)
r6_ct = Radiobutton(text="Standard Deviation", variable=var, value=6, font=("Arial", 10))
r6_ct.place(x=10, y=360)
r7_ct = Radiobutton(text="Quartiles", variable=var, value=7, font=("Arial", 10))
r7_ct.place(x=10, y=380)
r8_ct = Radiobutton(text="Variance", variable=var, value=8, font=("Arial", 10))
r8_ct.place(x=10, y=400)

# Create a "Calculate Central Tendency" button
calculate_ct_button = Button(text='Calculate Central Tendency', command=calculate_central_tendency, font=("Arial", 12))
...
quitButton = Button(text='Quit from System', command=root.destroy, font=("Arial", 12))
quitButton.place(x=200, y=530)
